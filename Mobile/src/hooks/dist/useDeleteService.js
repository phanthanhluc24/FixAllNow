...
var useDeleteService = function () {
    var destroyService = function (service_id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    accessToken = _a.sent();
                    return [4 /*yield*/, axios_1["default"].put(url_1.url + "/service/destroy/" + service_id, {}, {
                            headers: {
    ...
    return { destroyService: destroyService };
};
exports["default"] = useDeleteService;
