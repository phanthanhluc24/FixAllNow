...
var useGetDetailService = function (id) {
    var _a = react_1.useState(null), service = _a[0], setService = _a[1];
    var _b = react_1.useState(true), isLoading = _b[0], setIsLoading = _b[1];
    var _c = react_1.useState(false), isError = _c[0], setIsError = _c[1];
    react_1.useEffect(function () {
        var fetchDetailService = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        accessToken = _b.sent();
                        return [4 /*yield*/, axios_1["default"].get(url_1.url + "/service/" + id, {
    ...
    return { service: service, isLoading: isLoading, isError: isError };
};
exports["default"] = useGetDetailService;
