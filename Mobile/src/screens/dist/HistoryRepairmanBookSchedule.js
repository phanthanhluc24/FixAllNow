...
var useGetBookingNoRated_1 = require("../hooks/useGetBookingNoRated");
var HistoryRepairmanBookSchedule = function () {
    ...
    var bookingNorating = useGetBookingNoRated_1["default"]().bookingNorating;
        ...
        switch (transformedSelectedTab) {
            ...
            default:
                return react_1["default"].createElement(react_native_1.View, null,
                    "Unexpected tab value: ",
                    transformedSelectedTab); // Handle unexpected cases
        }
    };
